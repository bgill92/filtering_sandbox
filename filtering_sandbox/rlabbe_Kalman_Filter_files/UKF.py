...
class UnscentedKalmanFilter(object):
    ...
    def predict(self, dt=None, UT=None, fx=None, **fx_args):
        ...
        **fx_args : keyword arguments
        ...
        print("Before passing through unscented transform in predict")
        print("sigmas_f")
        print(self.sigmas_f)
        print("Wm")
        print(self.Wm)
        ...
        print("After unscented transform in predict")
        print("x")
        print(self.x)
        print("P")
        print(self.P)
        ...
        print("After sigma propagation in predict")
        print("sigmas_f")
        print(self.sigmas_f)
    ...
    def compute_process_sigmas(self, dt, fx=None, **fx_args):
        ...
        print("Before calculating initial sigmas")
        print("x")
        print(self.x)
        print("P")
        print(self.P)
        ...
        print("After calculating initial sigmas")
        print(sigmas)
        ...
        print("sigmas propagated through state transition")
        print(self.sigmas_f)            
